...
final class GeneratedTheSwitcherListHeldToOneDisplayIssue1391Tests: XCTestCase {
    func testTheSwitcherListHeldToOneDisplayIssue1391() {
        var checks = 0
        ...
        print("[generated-checks] TheSwitcherListHeldToOneDisplayIssue1391 \(checks)")
    }
}
