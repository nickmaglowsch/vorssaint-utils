...
final class GeneratedAnIdentityLessBuildThatInstallsCreatesItsStableSigningIdentityTests: XCTestCase {
    func testAnIdentityLessBuildThatInstallsCreatesItsStableSigningIdentity() {
        var checks = 0
        ...
        print("[generated-checks] AnIdentityLessBuildThatInstallsCreatesItsStableSigningIdentity \(checks)")
    }
}
